...
filePath <- "https://raw.githubusercontent.com/DanGitR/DDPWeek4AssignmentDJR/master/PWD2019Results.csv"  
        ...
        stockChampRow<-filter(pwdFile,Class=="StockChampion2018")
        stockChampSpeed<-stockChampRow$ScaleSpeed
        stockChampSpeed<-stockChampRow$ScaleSpeed
```
...
- The scaled speed for the 2018 stock champion was `r paste(format(stockChampSpeed,digits=1, nsmall=1)," scaled MPH",sep="")`.
